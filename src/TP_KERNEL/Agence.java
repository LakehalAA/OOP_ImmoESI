...
public class Agence {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            liste_proprios[1] = new Personne("prop", "1", "somewhere", "0550528764", "email1@email.dz", "prop1");
            liste_proprios[2] = new Personne("prop", "2", "somewhere", "0550528764", "email2@email.dz", "prop2");
            liste_proprios[3] = new Personne("prop", "3", "somewhere", "0550528764", "email3@email.dz", "prop3");
            liste_proprios[4] = new Personne("prop", "4", "somewhere", "0550528764", "email4@email.dz", "prop4");
            nb_proprios = 5;
